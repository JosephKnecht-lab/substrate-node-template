# Assumes node01 is listening for JSON RPC @ port 9933
...
# curl http://localhost:9935 -H "Content-Type:application/json;charset=utf-8" -d "@node02-insert-aura.json"
# curl http://localhost:9935 -H "Content-Type:application/json;charset=utf-8" -d "@node02-insert-gran.json"